...
export function MarketingFooter() {
    return (
        <footer className="bg-[#17262d] px-4 text-white sm:px-6">
            <div className="mx-auto max-w-7xl py-12 sm:py-16">
                ...
                >
                    <div>
                        ...
                        >
                            Sales, inventory, and practical guidance for small
                            businesses that need a clear view of what is
                            happening and what to do next.
                        </p>
                        <p
                            className={
                                "mt-5 text-xs font-semibold uppercase " +
                                "tracking-[0.16em] text-[#abd1d9]"
                            }
                        >
