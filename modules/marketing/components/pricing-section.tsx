...
export function PricingSection() {
    return (
        <section
            ...
            className={
                "scroll-mt-24 border-t border-[#dcebee] bg-white px-4 " +
                "py-16 text-[#203039] sm:px-6 lg:py-20"
            }
            id="pricing"
        >
            <WorkflowScrollReveal>
                ...
                >
                    ...
                    <div data-workflow-order="1" data-workflow-reveal>
                        <p
                            className={
                                "max-w-xl text-sm leading-7 text-[#5e6d75] " +
                                "sm:text-base"
                            }
                        >
                            Every plan includes KitaStock&apos;s core operations
                            and inventory intelligence. Higher plans expand
                            capacity and add tools for teams and unreliable
                            connections.
                        </p>
                ...
                >
                    ...
                    <div
                        className={
                            "border-t border-[#dcebee] bg-[#f5fafb] " +
                        ...
                        <div className="flex items-start gap-3">
                            <span
                                className={
                                    ...
                                    "rounded-xl bg-[#e2f0ec] text-[#2f6d5c]"
                                }
                            >
                            ...
                            <div>
                                ...
                                <p
                                    className={
                                        "mt-1 max-w-xl text-xs leading-5 " +
                                        "text-[#65747b]"
                                    }
                                >
                                    The weekly allowance changes with the plan;
                            ...
                            {intelligenceFeatures.map((feature) => (
                                <li
                                    className={
                                        ...
                                        "font-medium text-[#43545c]"
                                    }
                                    key={feature}
                                >
                                    <Check
                                        aria-hidden="true"
                                        className="size-3.5 text-[#2f6d5c]"
                                    />
                                    {feature}
                                </li>
                            ))}
                ...
                <div
                    className={
                        ...
                        "gap-4 text-xs text-[#718087] sm:flex-row " +
                        "sm:items-center"
                    }
                >
                    <p>
                        Yearly billing is available. Paid upgrades are reviewed
                        and activated after payment confirmation.
                    </p>
    ...
    return (
        <article
            className={
                ...
                (isFeatured
                    ? "border-[#203039] bg-[#203039] text-white"
                    : "border-[#dcebee] bg-white text-[#203039]")
            }
        >
            <div data-workflow-order={index} data-workflow-reveal>
                <div className="flex items-center justify-between gap-3">
                    ...
                    {plan.trial ? (
                        <span
                            className={
                                "rounded-full bg-[#d6edf1] px-3 py-1.5 " +
                ...
                <p
                    className={
                        ...
                        (isFeatured ? "text-[#abd1d9]" : "text-[#376674]")
                    }
                >
                    {plan.name}
                </p>
                ...
                <p
                    className={
                        "mt-2 text-xs " +
                        (isFeatured ? "text-white/50" : "text-[#718087]")
                    }
                >
                    {plan.priceNote}
                </p>
                <p
                    className={
                        ...
                        (isFeatured ? "text-white/65" : "text-[#5e6d75]")
                    }
                >
                    {plan.description}
                </p>
            ...
            <dl
                className={
                    ...
                    "rounded-2xl " +
                    (isFeatured ? "bg-white/10" : "bg-[#dcebee]")
                }
            >
                <PlanMetric
                    dark={isFeatured}
                ...
                {plan.features.map((feature) => (
                    <li
                        className={
                            ...
                            (isFeatured ? "text-white/75" : "text-[#52636b]")
                        }
                        key={feature}
                    >
                        <Check
            ...
            <Link
                className={
                    ...
                    (isFeatured
                        ? "bg-white text-[#203039] hover:bg-[#e7f2f5]"
                        : "border border-[#c9dfe3] text-[#245564] " +
                          "hover:bg-[#f1f7f8]")
                }
                href="/signup"
            >
        ...
        >
            <dt
                className={
                    ...
                    (dark ? "text-white/40" : "text-[#819198]")
                }
            >
                {label}
            </dt>
