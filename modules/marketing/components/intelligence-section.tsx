...
const principles = [
    {
        description:
            "Sales, stock, purchase, and count records produce the facts.",
        icon: Braces,
        title: "The system calculates.",
    },
    {
        description:
            "AI turns compact results into guidance an owner can act on.",
...
export function IntelligenceSection() {
    return (
        <section
            ...
            className={
                "scroll-mt-24 border-t border-white/10 bg-[#203039] " +
            ...
            <WorkflowScrollReveal>
                ...
                >
                    <div data-workflow-reveal>
                        ...
                        >
                            Your numbers first.
                            <span className="block text-[#abd1d9]">
                    ...
                    <div data-workflow-order="1" data-workflow-reveal>
                        <p
                            className={
                                "max-w-xl text-sm leading-7 text-white/65 " +
                                "sm:text-base"
                            }
                        >
                            KitaStock does not ask AI to invent inventory
                            answers. It calculates from your records, then uses
                            AI to communicate what changed, why it matters, and
                            what to review next.
                        </p>
                        <Link
                            className={
                                ...
                                "text-[#d6edf1] focus-visible:outline-2 " +
                ...
                <div className="mt-10 grid gap-px bg-white/10 sm:grid-cols-2">
                    {principles.map((principle, index) => {
                        ...
                        return (
                            <div
                                className="bg-[#203039] py-5 sm:px-6"
                                key={principle.title}
                            >
                                <div
