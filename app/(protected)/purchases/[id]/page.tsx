            ...
            <Card className="ml-auto max-w-md p-4">
                <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between">
                        ...
                        <span>
                            -₱
                            {purchase.discount_amount.toFixed(
                                2,
                            )}
                        </span>
                    </div>
                ...
                <DialogContent className="sm:max-w-md">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            ...
                            quantity of all items in
                            this purchase.
                        </DialogDescription>
                    </DialogHeader>

                    <div className="rounded-lg bg-amber-500/10 p-3 text-sm text-amber-700">
                        This action mutates inventory
                        stock and should only be done
                        once the supplier delivery has
                        been physically received.
                    </div>

                    {receiveError && (
                        <div className="rounded-lg border border-destructive/30 bg-destructive/5 p-3 text-sm text-destructive">
                            {receiveError instanceof
                            Error
            ...
            >
                <DialogContent className="sm:max-w-md">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            This purchase will be marked
                            as cancelled and can no
                            longer be received.
                        </DialogDescription>
                    </DialogHeader>
