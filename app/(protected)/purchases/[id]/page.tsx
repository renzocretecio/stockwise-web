...
export default function PurchaseDetailPage() {
        ...
        return (
            <div className="space-y-px bg-border">
                {[1, 2, 3, 4].map((item) => (
                    <div
                        key={item}
                        className="h-16 animate-pulse bg-muted/60"
                    />
                ))}
            </div>
        );
    ...
    return (
        <div className="pb-12">
            ...
            <section className="overflow-x-auto border-b">
            ...
            <div className="ml-auto max-w-md border-b p-4">
            ...
            <Dialog open={isReceiveOpen} onOpenChange={setIsReceiveOpen}>
                <DialogContent className="sm:max-w-md">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Receiving this purchase will increase the stock
                            quantity of all items in this purchase.
                        </DialogDescription>
                    </DialogHeader>

                    <div className="bg-amber-500/10 p-3 text-sm text-amber-700">
                        This action mutates inventory stock and should only be
                        done once the supplier delivery has been physically
                        received.
                    </div>
            ...
            <Dialog open={isCancelOpen} onOpenChange={setIsCancelOpen}>
                <DialogContent className="sm:max-w-md">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            This purchase will be marked as cancelled and can no
                            longer be received.
                        </DialogDescription>
                    </DialogHeader>
