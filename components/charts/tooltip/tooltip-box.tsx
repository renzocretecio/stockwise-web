...
/* eslint-disable react-hooks/refs -- tooltip placement uses measured DOM refs */
/* eslint-disable react-hooks/set-state-in-effect -- mount gates client portals */
...
function TooltipBoxInner({
  ...
  const panelClassName = cn(
    "min-w-[140px] overflow-hidden rounded-2xl border " +
      "border-border/70 text-chart-tooltip-foreground shadow-lg",
